...
\node (framework) at (2.875,-0.5) {Sensing matrix $\boldsymbol{\Phi}$};
\node[rotate=-90] (vector) at (7,-0.75) {Sparse vector $\mathbf{s}$};
\node[rotate=-90] (observation) at (8.5,1.5) {Observation $\mathbf{y}$};
