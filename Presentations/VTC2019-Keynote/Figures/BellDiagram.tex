...
\node[rotate=90] at (-0.4,2.3) {\small level~$0$};
\node[rotate=90] at (-0.4,0.5) {\small level~$1$};
\node[rotate=90] at (-0.4,-0.7) {\small level~$2$};
\node[rotate=90] at (-0.4,-2.3) {\small level~$3$};

\node[rotate=-90] at (6.8,0) {\small $j$-patterns};
\end{tikzpicture}
